...
public class GameState {
	...
	public String move(int player, int target) {
		...
		if (!isHit(player, target)) {
			...
			result = "Direct Hit!";
			playAudio("explosion-02.wav");
		} else if (!isShipLocation(player, target) && !isHit(player, target)) {
			result = "Your shot hit the water";
			playAudio("splash-02.wav");
		} else {
	...
	public class StatePlayer implements Runnable {
		...
		//public String[] board2 = new String[100];
		...
		//	board2 = new String[100]; 
			...
			// board
		//	for (int i = 0; i < 100; i++)
		//		board2[i] = new String("O"); // create player 1 BattleShip
			// board
